...
describe('Weather Component Testing', () => {
  ...
  before(async () => {
    ...
    global.navigator = {
      geolocation: {
        getCurrentPosition: sinon.stub().callsArgWith(0, { coords: { latitude: 37.7749, longitude: -122.4194 } })
      }
    };
    ...
    // The app is imported here because window needs to be defined.
    Weather = require('../index').default;
  });
